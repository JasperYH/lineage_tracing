df <- data.frame()
for (sample in list.files("../../Data/Subchallenge1/groundTruth_train/")) {
  gt_file <- paste("../../Data/Subchallenge1/groundTruth_train/",sample,sep="")
  gt_tree <- read.tree(gt_file)
  hc_file <- paste("./Output/Subchallenge1/HC/",sample,sep="")
